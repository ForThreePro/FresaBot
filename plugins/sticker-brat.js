...
let handler = async (m, { conn, text, usedPrefix, command }) => {
  ...
  if (!txt) return m.reply(`🍓 *𝗙𝗥𝗘𝗦𝗜𝗧𝗔 𝗕𝗢𝗧 - 𝗕𝗥𝗔𝗧* 🍓

*━━━━━━━━━━*
*⚠️ ERROR DE USO*

*➤* Escribe el texto para generar el *sticker Brat*
*➤* Ejemplo: *${usedPrefix + command} Hola Fresita*
...
*━━━━━━━━━━*`)
  ...
  let tmpInput = path.join(tmpdir(), `fresita-${Date.now()}.${ext}`)
  let tmpOutput = path.join(tmpdir(), `fresita-${Date.now()}.webp`)
