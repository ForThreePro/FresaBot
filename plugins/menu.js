...
let handler = async (m, { conn, usedPrefix }) => {
  ...
  let owner = global.owner?.[0]?.[0] || '56927308426'
  let ownerTag = `@${owner}`
  ...
  menu += `*Version*: 3.0 FRESITA\n`
  menu += `*Power*: Nivel Fresita\n`
  menu += `> "Odio los lunes... pero amo las fresitas"* 🍓\n`
  menu += `━━━━━━━━━━━`
