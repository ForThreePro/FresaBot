...
let handler = async (m, { conn, command }) => {
  ...
  if (['toimg', 'stickerimg', 'simg'].includes(command)) {
    ...
    if (!isSticker) return m.reply(`🍓 *𝗙𝗥𝗘𝗦𝗜𝗧𝗔 𝗕𝗢𝗧* 🍓\n\n*━━━━━━━━━━*\n*⚠️ ERROR DE USO*\n\n*➤* Responde a un *sticker*\n*➤* Ejemplo: Responde al sticker + *toimg*\n\n*━━━━━━━━━━*`)
    try {
      await conn.sendMessage(m.chat, { react: { text: '🖼️', key: m.key } })
      let media = await q.download()
      await conn.sendMessage(m.chat, { image: media, caption: `🍓 *𝗙𝗥𝗘𝗦𝗜𝗧𝗔 𝗕𝗢𝗧* 🍓\n\n*━━━━━━━━━━*\n*✅ STICKER CONVERTIDO*\n\n*➤* Tu *sticker* ya es *imagen JPG*\n*➤* Bot: ***FRESITA BOT***\n\n*━━━━━━━━━━*` }, { quoted: m })
      await conn.sendMessage(m.chat, { react: { text: '✅', key: m.key } })
    } catch {
      await conn.sendMessage(m.chat, { react: { text: '❌', key: m.key } })
